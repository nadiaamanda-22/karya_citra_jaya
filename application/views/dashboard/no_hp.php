                            ...
                            foreach ($no_hp as $nh) { ?>
                             <tr>
                                 ...
                                 <td style="text-align: center;">
                                     <a href="<?= base_url('Nohandphone/editView/' . $nh->no_hp) ?>" style="color: #3b5998;" title="Edit" class="mr-2"><i class="bi bi-pencil-square"></i></a>
                                     <a href="#" style="color: #3b5998;" title="Hapus" class="tombolHapus" data-id="<?= $nh->no_hp ?>"><i class="bi bi-trash3-fill"></i></a>
                                 </td>
                             </tr>
                         <?php } ?>
                     </tbody>
