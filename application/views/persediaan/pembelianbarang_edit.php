...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <p class="m-0">Edit Pembelian Barang</p>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?= base_url('pembelianbarang/editData/' . $data->id_pembelian) ?>" method="post">
                        <div class="mb-3">
                            <label for="supplier" class="form-label">Supplier *</label>
                            <input id="id_supplier" name="id_supplier" type="hidden" value="<?= $data->id_supplier ?>" />
                            <?php $supplier = $this->db->query("SELECT supplier FROM t_supplier WHERE id_supplier='$data->id_supplier'")->row()?->supplier ?>
                            <input type="text" class="form-control" id="supplier" name="supplier" required value="<?= $supplier ?>">
                        ...
                        <div class="row align-items-start">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="tgl_pembelian" name="tgl_pembelian" value="<?= $data->tgl_pembelian ?>">
                            </div>
                            <div class="col">
                            ...
                            <div class="col-12">
                                <table class="table table-bordered table-striped table-hover" width="100%">
                                    ...
                                    <tbody id="tableDynamic">
                                        ...
                                        ?>
                                            <tr id="rows2<?= $c ?>" class="border-b rowItem">
                                                <?php if ($c == 1) { ?>
                                                ...
                                                <?php } else { ?>
                                                    <td class="gray"><button type='button' id='btn1<?= $c ?>' name='btn1<?= $c ?>' class='btn btn-danger hapus' onClick='deleteRows2(<?= $c ?>)'><span class='fa fa-trash'></span></button></td>
                                                <?php } ?>
                                                <td class="gray">
                                                ...
                                                <td>
                                                    <input type="text" id="harga_beli6<?= $c ?>" name="harga_beli6<?= $c ?>" placeholder='0' class='form-control text-right harga_beli numeric-only iptPrice' onKeyUp="accSum(<?= $c ?>,2)" required value="<?= formatPrice($dt->harga_beli) ?>" />
                                                </td>
