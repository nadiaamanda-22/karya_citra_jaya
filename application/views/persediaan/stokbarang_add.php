                 ...
                 <div class="col-md-9">
                     <form action="<?= base_url('stokbarang/addData') ?>" method="post">
                         ...
                         <div class="mb-3">
                             ...
                             <option value="nama_kelompok" selected disable>--Pilih--</option>
                         ...
                         <div class="row align-items-start">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="stokbarang" name="stok">
                                </div>
                                <div class="col">
                            ...
                            <div class="mb-3">
                             ...
                             <input type="text" class="form-control" id="stokbarang" name="harga_beli">
                             <?php if ($this->session->flashdata('message', 'error')): ?>
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" class="form-control" id="stokbarang" name="harga_jual">
                             <?php if ($this->session->flashdata('message', 'error')): ?>
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" class="form-control" id="stokbarang" name="harga_permeter">
                         </div>
                         <div class="mb-5">
