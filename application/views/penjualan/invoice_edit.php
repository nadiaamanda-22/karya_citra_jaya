                                    ...
                                    <tbody id="tableDynamic">
                                        ...
                                        ?>
                                            <tr id="rows<?= $c ?>" class="border-b rowItem">
                                                ...
                                                <td>
                                                    <input type="text" id="harga_jual6<?= $c ?>" name="harga_jual6<?= $c ?>" placeholder='0' class='form-control text-right harga_jual numeric-only iptPrice' required value="<?= formatPrice($dt->harga_jual) ?>" />
                                                </td>
